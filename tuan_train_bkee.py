...
from transformers import (BertTokenizer, RobertaTokenizer, XLMRobertaTokenizer,
                           AlbertTokenizer, AutoModel, AutoTokenizer)
from tensorboardX import SummaryWriter

from src.model_vn import OneIE
...
config = Config.from_json_file(path="/home/tuanvm/ee/event-extraction-oneie/config/config_bkee.json")
